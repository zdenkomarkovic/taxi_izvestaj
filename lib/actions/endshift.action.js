...
export async function GetEndShifts(userId, page = 1, limit = null) {
  try {
    await connectToDatabase();
...
export async function GetEndShiftsCount(userId) {
  try {
    await connectToDatabase();
...
export async function GetEndShiftsByMonth(userId, year, month) {
  try {
    await connectToDatabase();
